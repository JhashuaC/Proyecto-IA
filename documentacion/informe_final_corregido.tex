...
\path{application/analyze_email.py} & Caso de uso principal. \\
\path{ai/feature_extractor.py} & Extrae características numéricas y tokens. \\
\path{ai/neural_network.py} & Red neuronal manual. \\
\path{ai/naive_bayes.py} & Clasificador Naive Bayes manual. \\
\path{ai/decision_tree.py} & Árbol de decisión manual. \\
\path{ai/expert_system.py} & Sistema experto de reglas. \\
